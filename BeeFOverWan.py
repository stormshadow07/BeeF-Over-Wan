...
if __name__ == '__main__':
    ...
    print(
        color("[*] IF you want to Do this Without Port Forwarding : Use NGROK\n"))
    ng_check = input(
        color("[?] Press '1' to see NGROK Instructions else Press '0' : "))
    print(ng_check)
    if (ng_check):
    ...
    if not os.path.isdir("./temp"):
        os.makedirs("./temp")
        print(
            color("[+] Creating [./temp] directory for resulting code files", "green"))
    else:
    ...
    print(color("\n==================================== RESULT ====================================\n", "blue"))
    print(color(
        "[+] Access The BeeF Control Panel Using : {}".format(connect_to_panel), "green"))
